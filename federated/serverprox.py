...
class FedProx:
    def __init__(self, dataset, device, args, model_trainer):
        ...
        self.ood_client = ClientProx(-1, None, None, ood_data, len(ood_data.dataset), self.args, self.device,
                                     model_trainer)
    ...
    def _local_val_on_all_clients(self, round_idx):
        ...
        for client_idx in range(self.client_num_in_total):
            ...
            logging.info(f"Validation - Client {client_idx}: Acc: {local_metrics['test_acc']:.4f}, Loss: {local_metrics['test_loss']:.4f}")
    ...
    def _local_test_on_all_clients(self, round_idx):
        ...
        for client_idx in range(self.client_num_in_total):
            ...
            logging.info(f"Test - Client {client_idx}: Acc: {test_local_metrics['test_acc']:.4f}, Loss: {test_local_metrics['test_loss']:.4f}")

...
from torchvision.models.resnet import BasicBlock, Bottleneck, resnet18, resnet34, resnet50, resnet101, resnet152
from torchvision.models._utils import IntermediateLayerGetter


from .routeconv import RouteConv2D, RouteConvTranspose2D

# 这段代码定义了一个基于 U-Net 架构的卷积神经网络模型，用于图像分割和自监督任务。模型由多个卷积层、批量归一化层和激活函数组成，通过跳跃连接保留特征信息。
# 模型还包括一个自定义的展平层，用于将特征展平成二维张量。模型可以处理两种任务：图像分割和自监督学习，通过 task 参数进行区分

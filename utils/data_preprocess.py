...
base_path = '/root/autodl-tmp/pythonproject/IOP-FL-main/dataset/Prostate/data'
tar_path = '/root/autodl-tmp/pythonproject/IOP-FL-main/dataset/Prostate/processed'
